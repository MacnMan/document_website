...
<div className="spec-block">
  <div className="spec-block-title">
    Time-of-Flight <br /> Measurement
  </div>
  <div className="spec-block-details">
<p className="label">Distance Range</p>
<p className="value">Long Range Mode: 4 cm to 400 cm *</p>
<p className="value">Short Range Mode: 4 cm to 130 cm *</p>
<br />
<p className="label">Sensors Grid Options</p>
<p className="value">2 X 2</p>
<p className="value">4 X 4</p>
<p className="value">8 X 8</p>
<br />
<p className="label">Accuracy</p>
<p className="value">±3% typical *</p>
<p className="value">&lt; ±5 mm (Indoor lighting conditions)</p>
<br />
<p className="label">Repeatability</p>
<p className="value">&lt; ±10 mm (under strong ambient light)</p>
<br />
<p className="label">Resolution</p>
<p className="value">Up to 1 mm</p>
<br />
<p className="label">Measurement Rate</p>
<p className="value">Up to 60 Hz (adjustable)</p>
<br />
<p className="label">Field of View (FoV)</p>
<p className="value">Programmable, up to 26° ~ 60°</p>
<br />
<p className="label">Ambient Light Immunity</p>
<p className="value">Up to 100k Lux (sunlight)</p>
<br />
<p className="label">Wavelength</p>
<p className="value">940 nm (IR, eye-safe & invisible)</p>
<br />
<p className="label">Response Time</p>
<p className="value">&lt; 25 ms (typical)</p>
<br />
<p className="label">Target Reflectivity Tolerance</p>
<p className="value">Reliable performance on dark, light, & low-reflective surfaces</p>
  </div>
</div>
