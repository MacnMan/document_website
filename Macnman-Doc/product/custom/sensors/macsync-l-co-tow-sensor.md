...
<div className="spec-block">
  ...
  <div className="spec-block-details">
<p className="label">CO₂ Measurement Range</p>
<p className="value">400 ppm – 2,000 ppm</p>
<p className="value">400 ppm – 5,000 ppm</p>
<br />

<p className="label">Accuracy</p>
<p className="value">± (50 ppm + 5% of reading)</p>
<br />

<p className="label">Repeatability</p>
<p className="value">± 10 ppm</p>
<br />

<p className="label">Response Time (T90)</p>
<p className="value">≤ 60 seconds</p>
<br />

<p className="label">Accuracy Drift (per year)</p>
<p className="value">± (5 ppm + 0.5% of reading)</p>
<br />

<p className="label">Sensor Type</p>
<p className="value">NDIR (Non‑Dispersive Infrared) with Auto‑Calibration</p>
<br />
...
<div className="spec-block">
  ...
  <div className="spec-block-details">
    ...
    <p className="value">-10 °C to +60 °C</p>
    <br />

    <p className="label">Accuracy</p>
    <p className="value">± 0.8 °C</p>
    <br />
    ...
    <p className="label">Accuracy Drift</p>
    <p className="value">&lt; 0.03 °C / year</p>
    <br />

    <p className="label">Sensor Type</p>
    <p className="value">Integrated Temperature Sensor</p>
    <br />
  </div>
</div>
...
<div className="spec-block">
  ...
  <div className="spec-block-details">
    ...
    <p className="label">Accuracy</p>
    <p className="value">±3% RH (10%–90% RH), ±5% RH (&lt;10% or &gt;90% RH)</p>
    <br />
...
<table className="parameter-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Battery Powered</td>
      <td>19 Ah</td>
      <td>Retrofit deployments, warehouses & logistics hubs</td>
    </tr>
  </tbody>
</table>
